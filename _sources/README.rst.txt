...
an emphasis on single- body watertight surfaces. The goal of the library
is to provide a full featured and well tested Trimesh object which
...
Python. <https://github.com/mikedh/trimesh/blob/master/trimesh/io/README.md>`__
